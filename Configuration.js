...
function getEndpoints(deviceAddress, endpoints) {
    ...
    var anglex = endpoints.addEndpoint("2", "Angle X", endpointType.genericSensor);
    anglex.variableTypeId = 1284;
    var angley = endpoints.addEndpoint("3", "Angle Y", endpointType.genericSensor);
    angley.variableTypeId = 1284;
    var anglez = endpoints.addEndpoint("4", "Angle Z", endpointType.genericSensor);
    anglez.variableTypeId = 1284;
    endpoints.addEndpoint("5", "Temperature sensor", endpointType.temperatureSensor);
  }
